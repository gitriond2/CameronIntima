<%@ Page Title="" Language="C#" MasterPageFile="~/MenuMaster.Master" AutoEventWireup="true" CodeBehind="Eliminar.aspx.cs" Inherits="CameronIntima.Eliminar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form>
        ...
        <table>
            ...
            <tr>
                <td>
                    <asp:Button ID="btnModificar" runat="server" Text="Eliminar"  />
                </td>
            </tr>
         </table>
    </form>
